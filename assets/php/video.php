...
class acf_field_video extends acf_field
{
	...
	*/
	function input_admin_enqueue_scripts()
	{
		...
		// register scripts
		wp_register_script( 'fitvids', $this->settings['dir'] . 'js/jquery.fitvids.js', array('jquery'), $this->settings['version'] );
		wp_register_script( 'acf-input-video', $this->settings['dir'] . 'js/input.js', array('acf-input', 'fitvids'), $this->settings['version'] );
